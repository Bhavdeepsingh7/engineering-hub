    ...
    <div className="min-h-screen bg-white dark:bg-surface-950 text-surface-900 dark:text-surface-50">
      ...
      <section className="px-4 pb-16 pt-24 sm:px-6 sm:pb-24 sm:pt-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="mb-5 text-4xl font-bold leading-tight tracking-tight sm:mb-6 sm:text-6xl">
            Engineering intelligence,<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-brand-400">on demand</span>
          </h1>

          <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-surface-500 dark:text-surface-400 sm:mb-10 sm:text-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={() => navigate("/dashboard")}
              className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-brand-600 px-6 py-3 text-sm font-medium text-white shadow-lg shadow-brand-600/25 transition-all hover:-translate-y-0.5 hover:bg-brand-700 hover:shadow-brand-600/40 sm:w-auto"
            >
              Get Started — it's free
              <ArrowRight size={16} />
            </button>
            <button className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl border border-surface-200 px-6 py-3 text-sm font-medium text-surface-700 transition-all hover:bg-surface-50 dark:border-surface-700 dark:text-surface-300 dark:hover:bg-surface-800 sm:w-auto">
              <GitBranch size={15} />
              View on GitHub
            </button>
          </div>
          ...
          <div className="relative mt-10 sm:mt-16">
            ...
            <div className="rounded-2xl border border-surface-200 dark:border-surface-700 bg-surface-50 dark:bg-surface-900 shadow-2xl shadow-surface-200/50 dark:shadow-black/50 overflow-hidden">
              ...
              <div className="space-y-4 p-3 text-left sm:p-6">
      ...
      {/* Features */}
      <section className="bg-surface-50 px-4 py-16 dark:bg-surface-900/50 sm:px-6 sm:py-24">
      ...
      {/* Footer */}
      <footer className="border-t border-surface-100 px-4 py-6 dark:border-surface-800 sm:px-6 sm:py-8">
